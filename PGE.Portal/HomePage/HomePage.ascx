...
<style>    
	...
	<div class="content">
		...
		<script type="text/javascript" src="/Style%20Library/jquery/jssor.slider.min.js"></script>
			...
			<div class="minislidephoto">			
				<div id="jssor_1" style="position: relative; margin: 0 auto; top: 0px; left: 0px; width: 809px; height: 150px; visibility: hidden;">
					...
					<div data-u="loading" style="position: absolute; top: 0px; left: 0px;">
						...
						<div style="position:absolute;display:block;background:url('/Style%20Library/images/minislide/loading.gif') no-repeat center center;top:0px;left:0px;width:100%;height:100%;"></div>
					</div>
