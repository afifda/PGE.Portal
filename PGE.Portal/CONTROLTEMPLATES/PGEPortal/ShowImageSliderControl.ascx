...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ShowImageSliderControl.ascx.cs" Inherits="PGE.Portal.CONTROLTEMPLATES.PGEPortal.ShowImageSliderControl" %>
